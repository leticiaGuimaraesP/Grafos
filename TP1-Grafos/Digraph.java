...
public class Digraph {
     ...
     */
    public Digraph(String arquivo) {
        //Faz a leitura da qtd de vertices e arestas e cria os vetores com os respectivos tamanhos
        ...
        try {
            ...
            this.V = Integer.parseInt(array[0])+1;
            ...
            while (sc.hasNextLine()) { //ou FOR
                ...
                //System.out.println(arestaO+" - "+arestaD);
                addEdge(arestaO, arestaD);
            }
        }
    ...
    public String toString() {
        ...
        s.append((V-1) + " vertices, " + E + " edges " + NEWLINE);
        for (int v = 1; v < V; v++) { //ignora o vertice 0, ja que ele não existe
